...
resource "null_resource" "app" {
    ...
    provisioner "remote-exec" {
        ...
        inline = [
            ...
            "ansible-pull -U https://github.com/krrinet-DevSecOps/roboshop-ansible.git Roboshop/roboshop-pull.yml -e env=${var.env_name} -e component=${var.name} -e token=${var.vault_token}"
        ]
    }
}
